...
SECRET_KEY = 'django-insecure-%^!(n$!4z(8p)bcvu%1$l%=#*d_+w$q*&egsarl@g-^n0)3pbz'
...
INSTALLED_APPS = [
    ...
    'dashboard_user.apps.DashboardUserConfig',
...
ROOT_URLCONF = 'celestial_art.urls'
...
WSGI_APPLICATION = 'celestial_art.wsgi.application'
